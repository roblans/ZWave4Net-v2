...
namespace ZWave.CommandClasses.Services
{
    internal class MultiChannelService : CommandClassService, IMultiChannel
    {
        ...
        public Task<MultiChannelEndpointsReport> GetEndpoints(CancellationToken cancellationToken = default)
        {
        ...
        public Task<MultiChannelCapabilityReport> GetCapability(byte endpointID, CancellationToken cancellationToken = default)
        {
